...
// 15. Create a variable with a number as a string (like "25") and log its type.
let num = "25";
...
// 17. Create three variables of types string, number and boolean, log their values.
let d = "hey", e = 15, f = true;
console.log(d, e, f);
